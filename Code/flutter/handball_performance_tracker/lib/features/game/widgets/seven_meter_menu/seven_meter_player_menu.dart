...
import 'seven_meter_player_button.dart';
          ...
          child: AlertDialog(
            ...
            content:
              ...
              children: [
                ...
                // this grid contains all the players of the team because everyone can execute the 
                GridView.count(
                  // 4 items max per row
                  crossAxisCount: 4,
                  padding: const EdgeInsets.all(20),
                  children: gameBloc.state.selectedTeam.players
                      .map((Player player) => SevenMeterPlayerButton(
                            player: player,
                          ))
                      .toList(),
                )
