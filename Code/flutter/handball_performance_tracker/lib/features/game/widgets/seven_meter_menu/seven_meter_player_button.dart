...
class SevenMeterPlayerButton extends StatelessWidget {
  Player player;
  // if the button is on the second page of the player menu (new players to be substituted)
  SevenMeterPlayerButton({super.key, required this.player});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        // TODO new game action here
        // gameBloc.add(RegisterAction(actionTag: , actionContext: actionContext))
        gameBloc.add(RegisterPlayerSelection(player: player, isSubstitute: false));
      },
    );
  }
}
