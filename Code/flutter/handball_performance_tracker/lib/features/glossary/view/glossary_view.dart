                  ...
                  children: [
                    ...
                    Flexible(
                      child: SingleChildScrollView(
                        ...
                        child: DataTable(
                          columns: [
                            DataColumn(label: Text('Aktion', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                            DataColumn(label: Text('Beschreibung', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                          ],
                          rows: [
                            DataRow(cells: [
                              DataCell(Text('Tor')),
                              DataCell(Text('Player erziehlt regelkonform ein Tor', softWrap: true)),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Assist')),
                              DataCell(Text('Ein Player bereitet ein Tor mit einer unmittelbaren Aktion vor')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Fehlwurf')),
                              DataCell(Text('Ein Player nimmt den Abschluss verwirft aber und bekommt auch kein Foul zugesprochen')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Foul')),
                              DataCell(Text('Ein Player begeht ein einfaches Foul (hier nicht Stürmerfoul)')),
                            ]),
                            DataRow(cells: [
                            ...
                            DataRow(cells: [
                              ...
                              DataCell(Text('Ein Player wird nach einer Aktion vom Schiedsrichter mit einer 2min Zeitstrafe belegt')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('7m ziehen')),
                              DataCell(
                                  Text('Ein Player zwingt die Abwehr mit einer 1vs1 Situation zu einer Aktion welche mit einem 7m bestraft wird')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('7m Strafwurf')),
                              DataCell(Text('Nach einer Aktion wird auf einen 7m Strafwurf entschieden')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Gelbe Karte')),
                              DataCell(Text('Eine Aktion eines Players wird mit der gelben Karte bestraft')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Rote Karte')),
                              DataCell(Text('Sich häufende Zeitstrafen oder eine einzelne Aktion führen zu einer roten Karte')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Block')),
                              DataCell(Text('Ein Player blockt den Wurfversuch eines Gegners')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('Block + Steal')),
                              DataCell(Text('Ein Block resultiert in einem direkten Ballgewinn für das Team')),
                            ]),
                            DataRow(cells: [
