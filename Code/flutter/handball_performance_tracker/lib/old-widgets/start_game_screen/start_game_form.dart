...
import 'package:handball_performance_tracker/old-widgets/start_game_screen/season_dropdown.dart';
import 'package:handball_performance_tracker/old-widgets/team_selection_screen/team_dropdown.dart';
import '../../old-constants/stringsDashboard.dart';
                            ...
                            child: _tempController.getSelectedTeam().name == ""
                                ...
                                : ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      bool gameExists = (currentGame.id == null)
                                          ? false
                                          : true;
                                      if (gameExists) {
                                        print("game exists");
                                        ...
                                        await persistentController
                                            .setCurrentGame(preconfiguredGame,
                                                isNewGame: true);
                                      }
