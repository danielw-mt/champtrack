...
import '../widgets/game_setup_screen/team_dropdown.dart';
import '../widgets/game_setup_screen/team_type_selection_bar.dart';
import '../widgets/game_setup_screen/add_new_team_form.dart';
import 'team_settings_screen.dart';

// A screen where all the available teams are listed for men, women and youth teams
class TeamsManagementScreen extends StatelessWidget {
                    ...
                    persistentController.getAvailableTeams().length == 0
                        ...
                        : Flexible(
                            child: ElevatedButton(
                                ...
                                child: Text(StringsTeamManagement.lEditTeam)),
                          ),
                    Container(
                      width: 20,
                    ),
