...
//   final TempController globalController = Get.find<TempController>();
//   List<Obx> dialogButtons = [];
//   for (Player player in globalController.getOnFieldPlayers()) {
...
//   final TempController tempController = Get.find<TempController>();
//   DatabaseRepository repository = tempController.repository;
...
//     GameAction lastAction = tempController;
//     String? lastClickedPlayerId = tempController.lastClickedPlayer.value.id;
...
//       // who was clicked
//       tempController.lastClickedPlayer.value = tempController
//           .selectedTeam.value.players
//           .where((Player playerItem) => (playerItem.id == associatedPlayer.id))
//           .first;
//       tempController.selectedTeam.refresh();
//       return;
//     }
...
//         lastAction.playerId = tempController.lastClickedPlayer.value.id!;
//         repository.updateAction(lastAction);
//         tempController.actions.last = lastAction;
//         // update player's ef-score
//         // TODO implement this
//         //activePlayer.addAction(lastAction);

//         tempController.lastClickedPlayer.value = Player();
...
//         tempController.actions.add(assistAction);
...
//     print(tempController.actions.last.toMap());
//     tempController.refresh();
...
//     if (tempController.lastClickedPlayer.value.lastName == buttonText) {
//       return DialogButton(
//           child: Column(
...
//           height: width * 0.14,
//           width: width * 0.14,
//           color: tempController.lastClickedPlayer.value == associatedPlayer
//               ? Colors.purple
